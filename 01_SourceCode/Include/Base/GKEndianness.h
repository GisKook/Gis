...
#define ISBIGENDIAN ((char)endian_test.l=='b')
...
#define swap64(args) ((args & 0x00000000000000FF) << 56 | (args & 0x000000000000FF00) << 40 |  (args & 0x0000000000FF0000) << 24 | (args & 0x00000000FF000000) << 8 |  (args & 0x000000FF00000000) >> 8 | (args & 0x0000FF0000000000) >> 24 | (args & 0x00FF000000000000) >> 40 | (args & 0xFF00000000000000) >> 56)
#endif
